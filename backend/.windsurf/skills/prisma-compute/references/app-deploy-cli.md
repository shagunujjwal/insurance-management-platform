...
If the deploy command returns JSON, parse the URL from the result and request that exact public URL. Do not accidentally test `http://localhost:5000` or `127.0.0.1` instead of public ingress.
