    ...
    try{
      ...
      if(editId){
        ...
        await axios.put(
          ...
          `https://insurance-management-platform-iem2.onrender.com:5000/api/policies/${editId}`,
  ...
  const deletePolicy=async(id)=>{
    ...
    try{
      ...
      await axios.delete(
        ...
        `https://insurance-management-platform-iem2.onrender.com:5000/api/policies/${id}`
